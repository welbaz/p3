...
%Weatherforecast=getsampleusingtime(WeatherforecastOrg,datenum(Starttime),datenum(Endtime));Elbaz
%17-01
Weatherforecast=resample(WeatherforecastOrg,datestr(Starttime:minutes(timestep):Endtime));
