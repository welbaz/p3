function [PVpredict,PVClearsky]=PVpredict(Location,Pvsystem,t,UTC,tree,WeatherforecastOrg,DiffMethod)
%this fumction generates [deterministic] prediction based on the regression
%tree created previously by PVtrain.m
