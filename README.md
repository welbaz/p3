...
The forecasts can be obtained by running 'Main.m'. All the other functions must be
present as well.

To obtain the weather forecasts, run 'AcquireWeather.m'. You must provide your API
