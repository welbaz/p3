...
ETR=S0*(1.00011+0.034221*cos(2*pi*(Refday-1)/365.25)+0.00128*sin(2*pi*(Refday-1)/365.25)+0.000719*cos(2*(2*pi*(Refday-1)/365.25))+0.000077*sin(2*(2*pi*(Refday-1)/365.25)));
